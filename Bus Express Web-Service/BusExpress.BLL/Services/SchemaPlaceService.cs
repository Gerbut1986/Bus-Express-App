namespace BusExpress.BLL.Services
{
    ...
    public class SchemaPlaceService : IADOService
    {
        private readonly string addQuery, updQuery, delQuery;
        private SqlConnection conn;
        private SqlCommand cmd;

        public SchemaPlaceService()
        {
            addQuery =
                ...
                " values(@BusNameNumber,@Is1Place,@Is2Place,@Is3Place,@Is4Place,@Is5Place,@Is6Place,@Is7Place,@Is8Place,@Is9Place,@Is10Place," +
                "@Is11Place,@Is12Place,@Is13Place,@Is14Place,@Is15Place,@Is16Place,@Is17Place,@Is18Place,@Is19Place,@Is20Place," +
                "@Is21Place,@Is22Place,@Is23Place,@Is24Place,@Is25Place,@Is26Place,@Is27Place,@Is28Place,@Is29Place,@Is30Place," +
                "@Is31Place,@Is32Place,@Is33Place,@Is34Place,@Is35Place,@Is36Place,@Is37Place,@Is38Place,@Is39Place,@Is40Place," +
                "@Is41Place,@Is42Place,@Is43Place,@Is44Place,@Is45Place,@Is46Place,@Is47Place,@Is48Place,@Is49Place,@Is50Place," +
        ...
        {
            var model = entity as SchemaPlaceDto;
            if (entity == null) return $"Not pass compatible model...You should to pass {nameof(SchemaPlaceDto)} model.";            
        ...
        public string UpdateOnePlc(int plcNum, string connStr, bool isRemove = false)
        {
            using (conn = new
